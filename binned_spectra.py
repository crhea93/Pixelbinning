...
#---------------------INPUTS---------------------#
filename = '/home/carterrhea/Documents/PixelBinning/pix_data.txt'
base_directory = '/home/carterrhea/Documents/AstronomyTools/Tests/NGC4636'
OBSIDS = ['323']
source_file = 'repro/super_mini'
background = 'blank'
output_dir = 'binned/'
#-----------------------------------------------#
#-------------------------------------------------#
